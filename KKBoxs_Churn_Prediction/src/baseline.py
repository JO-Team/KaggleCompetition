...
for i in range(fold):
    ...
    eval_cv = xgb.cv(params, xgb.DMatrix(x1, y1), num_boost_round=1500, feval=xgb_score, maximize=False, verbose_eval=50,
...
test[['msno','is_churn']].to_csv('submission_threshold_0.001.csv', index=False)
