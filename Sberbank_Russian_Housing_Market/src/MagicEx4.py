...
#model.save_model('../model/xgbmodel1.model')
...
model = xgb.train(dict(xgb_params, silent=0), dtrain, num_boost_round= num_boost_rounds)
#model.save_model('../model/xgbmodel2.model')

model = xgb.Booster({'nthread':4}) #init model
model.load_model('../model/xgbmodel2.model') # load data
...
#model.save_model('../model/xgbmodel3.model')

model = xgb.Booster({'nthread':4}) #init model
model.load_model('../model/xgbmodel3.model') # load data
