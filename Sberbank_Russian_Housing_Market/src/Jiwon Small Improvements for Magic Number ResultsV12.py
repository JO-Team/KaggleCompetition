...
# fill data<br>
clean_result = pd.read_csv("../input/fill.csv")
train.loc[train.id.isin(clean_result.key_id), ['max_floor', 'build_year', 'full_sq']] = clean_result[['max_floor_avg_100', 'build_year_avg_100', 'full_sq_avg_100']]
train.to_csv('fill_train.csv')
...
# fill data<br>
clean_result = pd.read_csv("../input/fill.csv")
df_train.loc[df_train.id.isin(clean_result.key_id), ['max_floor', 'build_year', 'full_sq']] = clean_result[['max_floor_avg_100', 'build_year_avg_100', 'full_sq_avg_100']]
